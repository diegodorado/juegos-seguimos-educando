...
;define("emberapp/components/fact", ["exports", "@glimmer/component", "@shopify/draggable"], function (_exports, _component, _draggable) {
  "use strict";
  ...
  /*
    <div class="facts" {{did-insert makeDraggable}} >
    {{#each facts as |f|}}
  ...
  */
  {
    id: "rlD6BWJS",
    block: "{\"symbols\":[\"f\"],\"statements\":[[9,\"div\",false],[23,\"class\",\"facts\",null],[3,0,0,[27,[26,1,\"ModifierHead\"],[]],[[27,[26,0,\"Expression\"],[]]],null],[10],[1,1,0,0,\"\\n\"],[5,[27,[26,4,\"BlockHead\"],[]],[[31,0,0,[27,[26,3,\"CallHead\"],[]],[[31,0,0,[27,[26,3,\"CallHead\"],[]],[[27,[26,2,\"Expression\"],[]]],null]],null]],null,[[\"default\"],[{\"statements\":[[1,1,0,0,\"    \"],[9,\"span\",true],[12,\"class\",\"draggable\",null],[10],[1,0,0,0,[27,[24,1],[]]],[11],[1,1,0,0,\"\\n\"]],\"parameters\":[1]}]]],[11],[1,1,0,0,\"\\n\"]],\"hasEval\":false,\"upvars\":[\"makeDraggable\",\"did-insert\",\"facts\",\"-track-array\",\"each\"]}",
    meta: {
      moduleName: "emberapp/components/fact.hbs"
    }
  });
  ...
  let Fact = (_dec = Ember.inject.service('audio'), (_class = (_temp = class Fact extends _component.default {
    constructor() {
      super(...arguments);
    ...
    makeDraggable(el) {
      ...
      const s = new _draggable.Swappable(el, {
        draggable: '.draggable',
        delay: 0
      }); // why??
    ...
    writable: true,
    initializer: null
  }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "facts", [Ember._tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  ...
  _exports.default = Fact;

  Ember._setComponentTemplate(__COLOCATED_TEMPLATE__, Fact);
});
;define("emberapp/components/game", ["exports", "@glimmer/component", "@shopify/draggable"], function (_exports, _component, _draggable) {
  ...
  /*
    ...
    <div class="splash" {{on 'click' this.start}} >
      ...
      <h3>Semana de Mayo</h3>
      <p>Arrastrá y ordená los sucesos de la Semana de Mayo.</p>
  ...
  */
  ...
  let Game = (_dec = Ember.inject.service('audio'), (_class = (_temp = class Game extends _component.default {
    constructor() {
      ...
      _defineProperty(this, "facts", ['El rey de España es apresado por Francia.', 'Los ciudadanos no quieren obedecer a un rey preso.', 'Los ciudadanos piden un Cabildo Abierto.', 'El virrey acepta realizar el Cabildo Abierto.', 'Se envían invitaciones para los participantes.', 'Los ciudadanos debaten en el Cabildo Abierto.', 'Se decide que el virrey deje de gobernar.', 'Se forma la Junta de Gobierno.', 'El pueblo festeja su libertad.']);
    }
  ...
  }), _applyDecoratedDescriptor(_class.prototype, "start", [Ember._action], Object.getOwnPropertyDescriptor(_class.prototype, "start"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "onWin", [Ember._action], Object.getOwnPropertyDescriptor(_class.prototype, "onWin"), _class.prototype)), _class));
